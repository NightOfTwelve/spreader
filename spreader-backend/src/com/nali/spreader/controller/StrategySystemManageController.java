...
public class StrategySystemManageController extends BaseController {
	private static final Logger LOGGER = Logger.getLogger(StrategySystemManageController.class);
	@Autowired
	...
	public String stgGridStore() {
		List<ConfigableInfo> list = passiveConfigService.listConfigableInfo(ConfigableType.system);
	...
	public String saveStrategyConfig(String name, String config) throws JsonGenerationException,
