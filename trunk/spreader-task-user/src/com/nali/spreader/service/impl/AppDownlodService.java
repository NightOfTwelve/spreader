...
//	}
	...
	@Override
	public List<Long> assignUidsIsPay(Integer websiteId, String appSource, Long appId, boolean payingTag, int count) {
		return assignUidsIsPay(websiteId, appSource, appId, payingTag, count, 0);
	}
