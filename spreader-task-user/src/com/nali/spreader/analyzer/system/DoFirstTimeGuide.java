...
public class DoFirstTimeGuide extends UserGroupExtendedBeanImpl implements RegularAnalyzer,
		Configable<Integer> {
	@AutowireProductLine
	...
	@Override
	public String work() {
		Iterator<Long> userIterator = this.userGroupFacadeService
				.queryAllGrouppedUser(getFromUserGroup());
		int count = 0;
		Calendar calendar = Calendar.getInstance();
		while (userIterator.hasNext()) {
			Long uid = userIterator.next();
